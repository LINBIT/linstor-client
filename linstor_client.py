...
class LinStorCLI(object):
    ...
    def setup_parser(self):
        ...
        p_fspace = subp.add_parser('list-free-space',
                                   ...
                                   aliases=['free-space'])
        p_fspace.add_argument('-m', '--machine-readable', choices=['text', 'json'], const='json', nargs='?')
        ...
        p_lsnaps.add_argument('-m', '--machine-readable', choices=['text', 'json'], const='json', nargs='?')
        ...
        p_lsnapas.add_argument('-m', '--machine-readable', choices=['text', 'json'], const='json', nargs='?')
